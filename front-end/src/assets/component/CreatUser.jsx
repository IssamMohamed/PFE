...
function CreatUser({onClose}) {
    ...
    const handleSubmission = async () => {
        try {
            const response = await fetch('http://localhost/back_endgenerale/CreatUser.php', {
                method: 'POST',
                headers: {
    ...
    <div className={Style.MainContaner}> 
        <div className={Style.mainContaner}>
           <label for="id">Id:</label>
            <input className={Style.inpt} type="text"  value={id} name='id' id='id' onChange={(e)=>setId(e.target.value)}/>
